...
<section class="d-flex justify-content-around w-100">
    ...
    <form action="" method="post" id="form-welcome" class="d-flex flex-column p-5">
        ...
        <a href="" class="text-decoration-underline mb-3 fw-semibold">Esqueceu sua senha?</a>

        <button type="submit" class="fs-3 fw-bold">Login</button>

        <a class="text-dark fs-3 text-center fw-bold mt-3">Crie sua conta</a>
    </form>
